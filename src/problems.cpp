...
void aru::problem12()
{
	...
	{
		std::cout
			<< std::boolalpha << aru::binary_search_iter(vec.begin(), vec.end(), i)
			<< '\n'
		;
	}

	bool fail = aru::binary_search_iter(vec.begin(), vec.end(), 7);
	bool fail2 = aru::binary_search_iter(vec.begin(), vec.end(), -1000);
	bool fail3 = aru::binary_search_iter(vec.begin(), vec.end(), 1000000);
